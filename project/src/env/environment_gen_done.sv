...
task Environment::wait_for_end();
	 ...
	 begin
	   fork
	       begin
                  wait((cfg.cells_per_chan[0] == 0)||(gen[0].gen_done.triggered));
                  $display("###### Port Number 0 is triggered ###############");
	       end
               begin
                  wait((cfg.cells_per_chan[1] == 0) || (gen[1].gen_done.triggered));
                  $display("###### Port Number 1 is triggered ###############");
	       end
               begin
                  wait((cfg.cells_per_chan[2] == 0) || (gen[2].gen_done.triggered));
                  $display("###### Port Number 2 is triggered ###############");
	       end
               begin
                  wait((cfg.cells_per_chan[3] == 0) || (gen[3].gen_done.triggered));
                  $display("###### Port Number 3 is triggered ###############");
	       end
           join
         end
