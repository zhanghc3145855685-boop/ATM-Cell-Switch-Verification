...
arbitor      arbit ( 
                      ...
                      //-------------------------------------------------
                      // 接收端 (RX) 接口连接：NNI 格式（12位VPI，无GFC）
                      //-------------------------------------------------
                      .rx0_rxreq          ( rx0_rxreq              ),
                      .rx0_rxack          ( rx0_rxack              ),
                      .rx0_nni_VPI        ( rx0_nni_VPI            ), 
                      .rx0_nni_VCI        ( rx0_nni_VCI            ),
                      .rx0_nni_CLP        ( rx0_nni_CLP            ), // 统一修改为 CLP
                      ...
                      .rx1_nni_CLP        ( rx1_nni_CLP            ), // 统一修改为 CLP
                      ...
                      .rx2_nni_CLP        ( rx2_nni_CLP            ), // 统一修改为 CLP
